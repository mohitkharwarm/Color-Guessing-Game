...
easyBtn.addEventListener("click", function() {
    ...
    document.querySelector("h1").style.background = "rgb(245, 12, 51)";

    statusText.textContent = "Let's Play!!";

    boxCount = 3;
    this.style.background = "rgb(245, 12, 51)"
    this.style.color = "white"
    hardBtn.style.background = "white";
    hardBtn.style.color = "rgb(245, 12, 51)";
...
hardBtn.addEventListener("click", function() {
    ...
    easyBtn.style.color = "rgb(245, 12, 51)";
